...
Las notas se modelan con tipos explicitos en TypeScript. Los filtros y resumen
se derivaran desde la lista actual para evitar duplicar estado calculable.

## SQL

El proyecto incluira modelado SQL en una carpeta `database/`. Esta base no sera
consumida por la aplicacion en esta fase, pero documentara como las notas,
categorias y etiquetas podrian organizarse en una base relacional.
...
El proyecto se preparara para GitHub Pages con `base: '/app-notas/'` en Vite y
workflow de publicacion al finalizar la fase de release.
